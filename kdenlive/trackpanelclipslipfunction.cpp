...
m_timeline(timeline),
m_document(document),
m_startedClipMove(false), m_masterClip(0), m_dragging(false)
{
...
bool TrackPanelClipSlipFunction::mouseApplies(Gui::KTrackPanel * panel,
...
QCursor TrackPanelClipSlipFunction::getMouseCursor(Gui::KTrackPanel *
    panel, QMouseEvent * event)
{
    return QCursor(Qt::ArrowCursor);
}

bool TrackPanelClipSlipFunction::mousePressed(Gui::KTrackPanel * panel,
    QMouseEvent * event)
{
    bool result = false;
...
bool TrackPanelClipSlipFunction::mouseMoved(Gui::KTrackPanel * panel,
    QMouseEvent * event)
{
    bool result = false;
...
// virtual
bool TrackPanelClipSlipFunction::dragEntered(Gui::KTrackPanel * panel,
...
// virtual
bool TrackPanelClipSlipFunction::dragMoved(Gui::KTrackPanel * panel,
...
// virtual
bool TrackPanelClipSlipFunction::dragLeft(Gui::KTrackPanel * panel,
...
// virtual
bool TrackPanelClipSlipFunction::dragDropped(Gui::KTrackPanel * panel,
    QDropEvent * event)
{
    if (ClipDrag::canDecode(event)) {
	if (!m_selection.isEmpty()) {
...
bool TrackPanelClipSlipFunction::moveSelectedClips(int newTrack,
    GenTime start)
{
    int trackOffset =
...
void TrackPanelClipSlipFunction::addClipsToTracks(DocClipRefList & clips,
...
void TrackPanelClipSlipFunction::initiateDrag(DocClipRef * clipUnderMouse,
    GenTime mouseTime)
{
