...
/** Edit Color clip */
KEditClipCommand::KEditClipCommand(KdenliveDoc &document, DocClipRef *clip, const QString &color, const GenTime &duration, const QString &name, const QString &description) :
		m_document(document),
		m_name("Color Clip"),
		m_parent(document.clipHierarch()->name())
{
	...
	document.clipManager().editColorClip(clip, color, duration, name, description);
...
/** Edit Image clip */
KEditClipCommand::KEditClipCommand(KdenliveDoc &document, DocClipRef *clip, const KURL &url, const QString &extension, const int &ttl, const GenTime &duration, const QString &description) :
		m_document(document),
		m_name(url.filename()),
		m_parent(document.clipHierarch()->name())
{
	...
	document.clipManager().editImageClip(clip, url, extension, ttl, duration, description);
...
KEditClipCommand::KEditClipCommand(KdenliveDoc &document, DocClipRef *clip, const KURL &url) :
		m_document(document),
		m_name(url.filename()),
		m_parent(document.clipHierarch()->name())
{
