...
public:
	...
	static KCommand * selectLaterClips( KdenliveDoc *document, GenTime time, bool include );

	/** Selects the clip on the given track at the given value. */
	static KCommand *selectClipAt( KdenliveDoc *document, const DocTrackBase &track, const GenTime &value );
	...
	static KCommand * toggleSelectClipAt( KdenliveDoc *document, const DocTrackBase &track, const GenTime &value );
