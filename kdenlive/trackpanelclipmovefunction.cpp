...
bool TrackPanelClipMoveFunction::moveSelectedClips( int newTrack, GenTime start )
{
...
void TrackPanelClipMoveFunction::addClipsToTracks( DocClipRefList &clips, int track, GenTime value, bool selected )
{
