...
:HQ:DV (Avi):PAL:::avformat:PAL:avi:format=avi vcodec=dvvideo acodec=pcm_s16le size=720x576
:HQ:DV (Avi):NTSC:::avformat:NTSC:avi:format=avi vcodec=dvvideo acodec=pcm_s16le size=720x480
