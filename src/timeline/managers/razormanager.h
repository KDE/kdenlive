 ...
 * @brief Provides convenience methods to handle razor tool.
 */
...
namespace RazorManager
{
     ...
     **/
    void checkOperation(QGraphicsItem *item, CustomTrackView *view, QMouseEvent *event, int eventPos, OperationType &operationMode, bool &abort);
};
