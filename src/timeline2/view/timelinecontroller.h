...
public:
    ...
    */
    bool selectCurrentItem(KdenliveObjectType::ItemType type, bool select, bool addToCurrent = false, bool showErrorMsg = true);
    ...
    */
     ...
     */
    Q_INVOKABLE void hideTrack(int trackId, bool hide, bool allTracks = false);
