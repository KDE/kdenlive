...
public:
   ...
   */
    ...
    */
   int promptAudioTrackCreation(int missingTracks, int streamCount, int &trackId, bool useTargets, bool effectiveFinalMove, QVector<int> &allowedTracks,
                                Fun &undo, Fun &redo, const QList<int> &streamsToCreate = QList<int>());
};
