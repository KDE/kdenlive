...
{
    ClipPropertiesController *panel = new ClipPropertiesController(static_cast<ProjectItemModel*>(m_model)->bin()->projectTimecode(), static_cast<ClipController*>(this), parent);
