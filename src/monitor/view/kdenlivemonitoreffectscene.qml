    ...
    Rectangle {
        ...
        Rectangle {
            ...
            MouseArea {
              ...
              onEntered: {
                if (!pressed) {
                  tophandle.color = framerect.hoverColor
                }
              }
              onExited: {
                if (!pressed) {
                  tophandle.color = '#ff0000'
                }
              }
              onPressed: mouse => {
                  root.captureRightClick = true
        ...
        Rectangle {
            ...
            MouseArea {
              ...
              onEntered: {
                if (!pressed) {
                  bottomhandle.color = framerect.hoverColor
                }
              }
              onExited: {
                if (!pressed) {
                  bottomhandle.color = '#ff0000'
                }
              }
              onPressed: mouse => {
                  root.captureRightClick = true
        ...
        Rectangle {
            ...
            MouseArea {
              ...
              onEntered: {
                if (!pressed) {
                  lefthandle.color = framerect.hoverColor
                }
              }
              onExited: {
                if (!pressed) {
                  lefthandle.color = '#ff0000'
                }
              }
              onPressed: mouse => {
                  root.captureRightClick = true
        ...
        Rectangle {
            ...
            MouseArea {
              ...
              onEntered: {
                if (!pressed) {
                  righthandle.color = framerect.hoverColor
                }
              }
              onExited: {
                if (!pressed) {
                  righthandle.color = '#ff0000'
                }
              }
              onPressed: mouse => {
                  root.captureRightClick = true
