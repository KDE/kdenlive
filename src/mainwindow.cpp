    ...
    m_mainClip(NULL)
{
    ...
    connect(m_effectStack, SIGNAL(reloadEffects()), SLOT(slotReloadEffects()));
    connect(m_effectStack, SIGNAL(displayMessage(QString,int)), SLOT(slotGotProgressInfo(QString,int)));
...
EffectStackView2* MainWindow::effectStack()
{
