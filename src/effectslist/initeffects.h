...
public:
    ...
    static void parseTransitionFile(EffectsList *transitionList, const QString &name, QStringList transitionNames, Mlt::Repository *repository, QMap <QString, QString> effectDescriptions);
