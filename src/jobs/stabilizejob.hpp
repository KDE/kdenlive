...
public:
    ...
    static int prepareJob(std::shared_ptr<JobManager> ptr, const std::vector<QString> &binIds, const std::vector<int> &parents, QString undoString, const QString &filterName);
